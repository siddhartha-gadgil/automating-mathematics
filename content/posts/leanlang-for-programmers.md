+++
title = "Leanlang for Programmers"
date = 2025-12-10T10:09:51Z
draft = false
tags = []
categories = []
+++

This is an announcement for the following workshop.

## Informal Workshop: LeanLang for Programmers

[Lean](https://www.renaissancephilanthropy.org/) (or Lean Prover) is an open-source programming language and proof assistant that enables correct, maintainable, and formally verified code. There has been a lot of interest in Lean recently, especially with the hope that it can enable AI to be used reliably in mathematics, software and beyond.
...
The workshop is free and is funded under a grant from [Renaissance Philanthropy](https://www.renaissancephilanthropy.org/). However, as we need to know the number of participants please [register](https://forms.gle/dDptN5t6azhB9fzz8) by **Monday, December 15, 2025** if you are interested in attending.
