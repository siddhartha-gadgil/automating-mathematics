...
Formalization is explaining a proof to a computer, i.e., writing a proof in a form that a computer can understand. This is typically done in an interactive theorem prover, as in our case where we used __lean 4__. 
...
* merging coefficients for equal elements, 
* deleting terms with zero coefficients, 
* swapping terms, and 
* prepending the same term to two formal sums related by an elementary move. 
