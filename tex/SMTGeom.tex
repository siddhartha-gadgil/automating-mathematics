...
A geometric statement is true if and only if the corresponding equations and inequations are \emph{unsatisfiable}.
...
\subsection{Next attempts: solving, proving Menelaus's theorem}
