...
solver from Microsoft (which is open source), was used to solve a Sudoku problem (a standard demo for
...
An interactive notebook with code for our examples is available onlineon Binder at 
